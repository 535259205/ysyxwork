...
module spi_xip (
  ...
  localparam s_entry = 3'd1;
  localparam s_start = 3'd2;
  localparam s_read_reg = 3'd3;
  localparam s_write_reg = 3'd4;
  ...
  always @(*) begin
    case(s_stateReg)
      ...
      s_entry : s_stateReg_string = "entry    ";
      s_start : s_stateReg_string = "start    ";
      s_read_reg : s_stateReg_string = "read_reg ";
      s_write_reg : s_stateReg_string = "write_reg";
  ...
  always @(*) begin
    case(s_stateNext)
      ...
      s_entry : s_stateNext_string = "entry    ";
      s_start : s_stateNext_string = "start    ";
      s_read_reg : s_stateNext_string = "read_reg ";
      s_write_reg : s_stateNext_string = "write_reg";
  ...
  assign s_onExit_entry = ((s_stateNext != s_entry) && (s_stateReg == s_entry));
  assign s_onExit_start = ((s_stateNext != s_start) && (s_stateReg == s_start));
  assign s_onExit_read_reg = ((s_stateNext != s_read_reg) && (s_stateReg == s_read_reg));
  assign s_onExit_write_reg = ((s_stateNext != s_write_reg) && (s_stateReg == s_write_reg));
  assign s_onEntry_BOOT = ((s_stateNext == s_BOOT) && (s_stateReg != s_BOOT));
  assign s_onEntry_entry = ((s_stateNext == s_entry) && (s_stateReg != s_entry));
  assign s_onEntry_start = ((s_stateNext == s_start) && (s_stateReg != s_start));
  assign s_onEntry_read_reg = ((s_stateNext == s_read_reg) && (s_stateReg != s_read_reg));
  assign s_onEntry_write_reg = ((s_stateNext == s_write_reg) && (s_stateReg != s_write_reg));
