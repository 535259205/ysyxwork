...
// Component : ysyx_26010010_ysyx_26010010
...
module ysyx_26010010_AXIClint (
  ...
  ysyx_26010010_my_debug_1 debug (
  ...
  assign when_Axi4Channel_l323 = (axi_aw_payload_len != 8'h0);
  ...
  assign when_Stream_l477 = (! axi_writeRsp_stage_valid);
  ...
  assign when_Axi4Channel_l323_1 = (axi_ar_payload_len != 8'h0);
  always @(*) begin
  ...
  assign when_Stream_l477_1 = (! axi_readDataStage_valid);
  ...
  assign when_pipCPUTOP_l135 = (mtime_L == 32'hffffffff);
...
module ysyx_26010010_test_cpu (
  ...
  assign _zz__zz_1 = pip_ctrl_5_down_RD_sel[3:0];
  assign _zz_WB_gpr_rdata_1 = pip_ctrl_5_down_CSR_rs1_imm[3:0];
  assign _zz__zz_2 = pip_ctrl_5_down_RD_sel[3:0];
...
module ysyx_26010010_my_debug_1 (
