...
module Encode (
  ...
  wire       [31:0]   _zz_when_MyCpu_l531_2;
  wire       [31:0]   _zz_when_MyCpu_l531_2_1;
  wire       [31:0]   _zz_com_pc_nPC_3;
  wire       [31:0]   _zz_when_MyCpu_l531_3;
  wire       [31:0]   _zz_when_MyCpu_l531_3_1;
  ...
  assign _zz_when_MyCpu_l531_2 = com_grp_rs1;
  assign _zz_when_MyCpu_l531_2_1 = com_grp_rs2;
  assign _zz_com_pc_nPC_3 = (pc_pc + imm_B);
  assign _zz_when_MyCpu_l531_3 = com_grp_rs2;
  assign _zz_when_MyCpu_l531_3_1 = com_grp_rs1;
  ...
  assign when_MyCpu_l450 = (axi4lite_w_fire || axi4lite_r_fire);
  always @(*) begin
    ar_size = 4'b1111;
    casez(code)
      32'b0000000??????????000?????0110011 : begin
      ...
      32'b?????????????????000?????0000011 : begin
        ar_size = switch_MyCpu_l460;
      end
      32'b?????????????????001?????0000011 : begin
        ar_size = switch_MyCpu_l460_1;
      end
      32'b?????????????????010?????0000011 : begin
        ar_size = switch_MyCpu_l460_2;
      end
      32'b?????????????????100?????0000011 : begin
        ar_size = switch_MyCpu_l460_3;
      end
      32'b?????????????????101?????0000011 : begin
        ar_size = switch_MyCpu_l460_4;
      end
      32'b?????????????????000?????1100111 : begin
      end
      32'b?????????????????010?????0100011 : begin
  ...
  always @(*) begin
    ...
    casez(code)
      ...
      32'b?????????????????000?????1100011 : begin
        if(when_MyCpu_l531) begin
          com_pc_nPC = _zz_com_pc_nPC_1;
        end
      end
      32'b?????????????????001?????1100011 : begin
        if(when_MyCpu_l531_1) begin
          com_pc_nPC = _zz_com_pc_nPC_2;
        end
      end
      32'b?????????????????100?????1100011 : begin
        if(when_MyCpu_l531_2) begin
          com_pc_nPC = _zz_com_pc_nPC_3;
        end
      end
      32'b?????????????????101?????1100011 : begin
        if(when_MyCpu_l531_3) begin
          com_pc_nPC = _zz_com_pc_nPC_4;
        end
      end
      32'b?????????????????110?????1100011 : begin
        if(when_MyCpu_l531_4) begin
          com_pc_nPC = _zz_com_pc_nPC_5;
        end
      end
      32'b?????????????????111?????1100011 : begin
        if(when_MyCpu_l531_5) begin
  ...
  assign switch_MyCpu_l460 = 4'b0001;
  assign when_MyCpu_l462 = 1'b1;
  assign _zz_com_grp_rd = ({3'd0,_zz_axi4lite_ar_payload_addr[1 : 0]} <<< 2'd3);
  always @(*) begin
    case(switch_MyCpu_l460)
      4'b0001 : begin
        if(when_MyCpu_l462) begin
  ...
  assign switch_MyCpu_l460_1 = 4'b0011;
  assign when_MyCpu_l462_1 = 1'b1;
  assign _zz_com_grp_rd_2 = ({3'd0,_zz_axi4lite_ar_payload_addr_1[1 : 0]} <<< 2'd3);
  always @(*) begin
    case(switch_MyCpu_l460_1)
      4'b0001 : begin
        if(when_MyCpu_l462_1) begin
  ...
  assign switch_MyCpu_l460_2 = 4'b1111;
  assign when_MyCpu_l462_2 = 1'b1;
  assign _zz_com_grp_rd_4 = ({3'd0,_zz_axi4lite_ar_payload_addr_2[1 : 0]} <<< 2'd3);
  always @(*) begin
    case(switch_MyCpu_l460_2)
      4'b0001 : begin
        if(when_MyCpu_l462_2) begin
  ...
  assign switch_MyCpu_l460_3 = 4'b0001;
  assign when_MyCpu_l462_3 = 1'b0;
  assign _zz_com_grp_rd_6 = ({3'd0,_zz_axi4lite_ar_payload_addr_3[1 : 0]} <<< 2'd3);
  always @(*) begin
    case(switch_MyCpu_l460_3)
      4'b0001 : begin
        if(when_MyCpu_l462_3) begin
  ...
  assign switch_MyCpu_l460_4 = 4'b0011;
  assign when_MyCpu_l462_4 = 1'b0;
  assign _zz_com_grp_rd_8 = ({3'd0,_zz_axi4lite_ar_payload_addr_4[1 : 0]} <<< 2'd3);
  always @(*) begin
    case(switch_MyCpu_l460_4)
      4'b0001 : begin
        if(when_MyCpu_l462_4) begin
  ...
  assign switch_MyCpu_l494 = _zz_axi4lite_aw_payload_addr[1 : 0];
  assign _zz_axi4lite_aw_payload_addr_1 = (com_grp_rs1 + imm_S);
  assign switch_MyCpu_l510 = (_zz_axi4lite_aw_payload_addr_1 & 32'h00000003);
  assign when_MyCpu_l531 = ((com_grp_rs1 == com_grp_rs2) == 1'b1);
  assign when_MyCpu_l531_1 = ((com_grp_rs1 != com_grp_rs2) == 1'b1);
  assign when_MyCpu_l531_2 = (($signed(_zz_when_MyCpu_l531_2) < $signed(_zz_when_MyCpu_l531_2_1)) == 1'b1);
  assign when_MyCpu_l531_3 = (($signed(_zz_when_MyCpu_l531_3) <= $signed(_zz_when_MyCpu_l531_3_1)) == 1'b1);
  assign when_MyCpu_l531_4 = ((com_grp_rs1 < com_grp_rs2) == 1'b1);
  assign when_MyCpu_l531_5 = ((com_grp_rs2 <= com_grp_rs1) == 1'b1);
