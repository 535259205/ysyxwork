error id: file://<WORKSPACE>/hw/spinal/MY_Prj/SysConfig.scala:
file://<WORKSPACE>/hw/spinal/MY_Prj/SysConfig.scala
...
non-local guesses:
	 ...
	 -scala/Predef.fa().
offset: 2873
uri: file://<WORKSPACE>/hw/spinal/MY_Prj/SysConfig.scala
text:
```scala
package SysConfig
...
object Sys{
  val spinalConfig =SpinalConfig(
      ...
      // targetDirectory = "<HOME>/study/YSYX_data/ysyx-workbench/npc/vsrc/ysyxsoc",
      // targetDirectory = "<HOME>/study/YSYX_data/ysyx-workbench/YSYX_SOC/ysyxSoC/perip/amba",
      ...
      dontCareGenAsZero = false ,//将dontCare信号生成的Verilog代码设为0
...
object MyTopLevelApp extends App {
  ...
  val spinalConfig =SpinalConfig(
      ...
      dontCareGenAsZero = false ,//将dontCare信号生成的Verilog代码设为0
      noAssert = true,//是否禁用断言
      oneFilePerComponent = f@@a,//每个组件生成一个Verilog文件
    )
    spinalConfig.targetDirectory="../npc/build/"
    spinalConfig.generateVerilog(new MY_Prj.pipCPU_TOP.ysyx_soc_sim()).printPruned()
  }
