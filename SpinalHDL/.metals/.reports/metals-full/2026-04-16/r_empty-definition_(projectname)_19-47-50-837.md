error id: file://<WORKSPACE>/hw/spinal/MY_Prj/pipCPU/pipCPU.scala:step
file://<WORKSPACE>/hw/spinal/MY_Prj/pipCPU/pipCPU.scala
empty definition using pc, found symbol in pc: step
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -spinal/core/step/io/step.
	 -spinal/core/step/io/step#
	 -spinal/core/step/io/step().
	 -spinal/lib/step/io/step.
	 -spinal/lib/step/io/step#
	 -spinal/lib/step/io/step().
	 -spinal/lib/misc/pipeline/step/io/step.
	 -spinal/lib/misc/pipeline/step/io/step#
	 -spinal/lib/misc/pipeline/step/io/step().
	 -spinal/lib/fsm/step/io/step.
	 -spinal/lib/fsm/step/io/step#
	 -spinal/lib/fsm/step/io/step().
	 -MY_Prj.ysyxcomm.Ysyx.step.io.step.
	 -MY_Prj.ysyxcomm.Ysyx.step.io.step#
	 -MY_Prj.ysyxcomm.Ysyx.step.io.step().
	 -spinal/lib/bus/amba4/axi/step/io/step.
	 -spinal/lib/bus/amba4/axi/step/io/step#
	 -spinal/lib/bus/amba4/axi/step/io/step().
	 -MY_Prj.ysyxcomm.step.io.step.
	 -MY_Prj.ysyxcomm.step.io.step#
	 -MY_Prj.ysyxcomm.step.io.step().
	 -step/io/step.
	 -step/io/step#
	 -step/io/step().
	 -scala/Predef.step.io.step.
	 -scala/Predef.step.io.step#
	 -scala/Predef.step.io.step().
offset: 23130
...
//接入外部的和Veriltor联调的部分
  ...
  val step_flag =Bool()
  step.io.s@@tep:=(pip.ctrl(4).down.valid)
