error id: file://<WORKSPACE>/hw/spinal/MY_Prj/pipCPU/pipCPU.scala:pipCPU/EX_stage#CSR_fun.
...
non-local guesses:
	 ...
	 -spinal/lib/CSR_fun#
	 -spinal/lib/CSR_fun().
	 -spinal/lib/misc/pipeline/CSR_fun.
	 -spinal/lib/misc/pipeline/CSR_fun#
	 -spinal/lib/misc/pipeline/CSR_fun().
	 -spinal/lib/fsm/CSR_fun.
	 -spinal/lib/fsm/CSR_fun#
	 -spinal/lib/fsm/CSR_fun().
	 -MY_Prj.ysyxcomm.Ysyx.CSR_fun.
	 -MY_Prj.ysyxcomm.Ysyx.CSR_fun#
	 -MY_Prj.ysyxcomm.Ysyx.CSR_fun().
	 -spinal/lib/bus/amba4/axi/CSR_fun.
	 -spinal/lib/bus/amba4/axi/CSR_fun#
	 -spinal/lib/bus/amba4/axi/CSR_fun().
	 -MY_Prj.ysyxcomm.CSR_fun.
	 -MY_Prj.ysyxcomm.CSR_fun#
	 -MY_Prj.ysyxcomm.CSR_fun().
	 -CSR_fun.
	 -CSR_fun#
	 -CSR_fun().
	 -scala/Predef.CSR_fun.
	 -scala/Predef.CSR_fun#
	 -scala/Predef.CSR_fun().
offset: 7812
...
class EX_stage(
    ...
    val csr_fun = stage.down(CS@@R_fun)
