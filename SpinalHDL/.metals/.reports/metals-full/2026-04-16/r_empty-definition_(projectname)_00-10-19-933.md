error id: file://<WORKSPACE>/hw/spinal/MY_Prj/pipCPU/pipCPU.scala:RVFun/RVCodeDef#RVCode.CSRRS.
file://<WORKSPACE>/hw/spinal/MY_Prj/pipCPU/pipCPU.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol RVFun/RVCodeDef#RVCode.CSRRS.
...
//写回控制部分
    ...
    val WB = new pip.Ctrl(5){
      ...
      is(CSRR@@S ){csr_wdata:=gpr_rdata | csr_rdata}
