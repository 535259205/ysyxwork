error id: file://<WORKSPACE>/hw/spinal/MY_Prj/pipCPU/pipCPU.scala:pipCPU/EX_stage#`<init>`().(fence_i)
file://<WORKSPACE>/hw/spinal/MY_Prj/pipCPU/pipCPU.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol pipCPU/EX_stage#fence_i.
