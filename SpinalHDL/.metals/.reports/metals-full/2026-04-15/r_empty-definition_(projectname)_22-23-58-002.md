error id: file://<WORKSPACE>/hw/spinal/MY_Prj/SysConfig.scala:MyCpu/MyCpu.ysyxSoCFull#
file://<WORKSPACE>/hw/spinal/MY_Prj/SysConfig.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol MyCpu/MyCpu.ysyxSoCFull#
...
object MyTopLevelApp extends App {
  ...
  if (true) {
    ...
    println("Generating MyCpu.TOP...")
    spinalConfig.targetDirectory="../npc/vsrc_npc/ysyx_soc"
    spinalConfig.generateVerilog(new MY_Prj.ysyxcomm.@@ysyxSoCFull).printPruned()
  }
}
