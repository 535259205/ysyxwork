...
module ysyxSoCFull (
  ...
  wire                uart_AxiIn_aw_ready;
  wire                uart_AxiIn_w_ready;
  wire                uart_AxiIn_b_valid;
  wire       [1:0]    uart_AxiIn_b_payload_resp;
  wire                uart_AxiIn_ar_ready;
  wire                uart_AxiIn_r_valid;
  wire       [31:0]   uart_AxiIn_r_payload_data;
  wire       [1:0]    uart_AxiIn_r_payload_resp;
  wire                clint_AxiIn_aw_ready;
  wire                clint_AxiIn_w_ready;
  wire                clint_AxiIn_b_valid;
  wire       [1:0]    clint_AxiIn_b_payload_resp;
  wire                clint_AxiIn_ar_ready;
  wire                clint_AxiIn_r_valid;
  wire       [31:0]   clint_AxiIn_r_payload_data;
  wire       [1:0]    clint_AxiIn_r_payload_resp;
  ...
  AXImem aximem_1 (
    .axi4lite_aw_valid        (axiarbiter_1_AxiOut_0_aw_valid             ), //i
    .axi4lite_aw_ready        (aximem_1_axi4lite_aw_ready                 ), //o
    .axi4lite_aw_payload_addr (axiarbiter_1_AxiOut_0_aw_payload_addr[31:0]), //i
    .axi4lite_aw_payload_prot (axiarbiter_1_AxiOut_0_aw_payload_prot[2:0] ), //i
    .axi4lite_w_valid         (axiarbiter_1_AxiOut_0_w_valid              ), //i
    .axi4lite_w_ready         (aximem_1_axi4lite_w_ready                  ), //o
    .axi4lite_w_payload_data  (axiarbiter_1_AxiOut_0_w_payload_data[31:0] ), //i
    .axi4lite_w_payload_strb  (axiarbiter_1_AxiOut_0_w_payload_strb[3:0]  ), //i
    .axi4lite_b_valid         (aximem_1_axi4lite_b_valid                  ), //o
    .axi4lite_b_ready         (axiarbiter_1_AxiOut_0_b_ready              ), //i
    .axi4lite_b_payload_resp  (aximem_1_axi4lite_b_payload_resp[1:0]      ), //o
    .axi4lite_ar_valid        (axiarbiter_1_AxiOut_0_ar_valid             ), //i
    .axi4lite_ar_ready        (aximem_1_axi4lite_ar_ready                 ), //o
    .axi4lite_ar_payload_addr (axiarbiter_1_AxiOut_0_ar_payload_addr[31:0]), //i
    .axi4lite_ar_payload_prot (axiarbiter_1_AxiOut_0_ar_payload_prot[2:0] ), //i
    .axi4lite_r_valid         (aximem_1_axi4lite_r_valid                  ), //o
    .axi4lite_r_ready         (axiarbiter_1_AxiOut_0_r_ready              ), //i
  ...
  AXIArbiter axiarbiter_1 (
    ...
    .AxiOut_0_aw_ready        (aximem_1_axi4lite_aw_ready                 ), //i
    ...
    .AxiOut_0_w_ready         (aximem_1_axi4lite_w_ready                  ), //i
    ...
    .AxiOut_0_b_valid         (aximem_1_axi4lite_b_valid                  ), //i
    .AxiOut_0_b_ready         (axiarbiter_1_AxiOut_0_b_ready              ), //o
    .AxiOut_0_b_payload_resp  (aximem_1_axi4lite_b_payload_resp[1:0]      ), //i
    .AxiOut_0_ar_valid        (axiarbiter_1_AxiOut_0_ar_valid             ), //o
    .AxiOut_0_ar_ready        (aximem_1_axi4lite_ar_ready                 ), //i
    ...
    .AxiOut_0_r_valid         (aximem_1_axi4lite_r_valid                  ), //i
    .AxiOut_0_r_ready         (axiarbiter_1_AxiOut_0_r_ready              ), //o
    .AxiOut_0_r_payload_data  (aximem_1_axi4lite_r_payload_data[31:0]     ), //i
    .AxiOut_0_r_payload_resp  (aximem_1_axi4lite_r_payload_resp[1:0]      ), //i
    .AxiOut_1_aw_valid        (axiarbiter_1_AxiOut_1_aw_valid             ), //o
    .AxiOut_1_aw_ready        (uart_AxiIn_aw_ready                        ), //i
    ...
    .AxiOut_1_w_ready         (uart_AxiIn_w_ready                         ), //i
    ...
    .AxiOut_1_b_valid         (uart_AxiIn_b_valid                         ), //i
    .AxiOut_1_b_ready         (axiarbiter_1_AxiOut_1_b_ready              ), //o
    .AxiOut_1_b_payload_resp  (uart_AxiIn_b_payload_resp[1:0]             ), //i
    .AxiOut_1_ar_valid        (axiarbiter_1_AxiOut_1_ar_valid             ), //o
    .AxiOut_1_ar_ready        (uart_AxiIn_ar_ready                        ), //i
    ...
    .AxiOut_1_r_valid         (uart_AxiIn_r_valid                         ), //i
    .AxiOut_1_r_ready         (axiarbiter_1_AxiOut_1_r_ready              ), //o
    .AxiOut_1_r_payload_data  (uart_AxiIn_r_payload_data[31:0]            ), //i
    .AxiOut_1_r_payload_resp  (uart_AxiIn_r_payload_resp[1:0]             ), //i
    .AxiOut_2_aw_valid        (axiarbiter_1_AxiOut_2_aw_valid             ), //o
    .AxiOut_2_aw_ready        (clint_AxiIn_aw_ready                       ), //i
    ...
    .AxiOut_2_w_ready         (clint_AxiIn_w_ready                        ), //i
    ...
    .AxiOut_2_b_valid         (clint_AxiIn_b_valid                        ), //i
    .AxiOut_2_b_ready         (axiarbiter_1_AxiOut_2_b_ready              ), //o
    .AxiOut_2_b_payload_resp  (clint_AxiIn_b_payload_resp[1:0]            ), //i
    .AxiOut_2_ar_valid        (axiarbiter_1_AxiOut_2_ar_valid             ), //o
    .AxiOut_2_ar_ready        (clint_AxiIn_ar_ready                       ), //i
    ...
    .AxiOut_2_r_valid         (clint_AxiIn_r_valid                        ), //i
    .AxiOut_2_r_ready         (axiarbiter_1_AxiOut_2_r_ready              ), //o
    .AxiOut_2_r_payload_data  (clint_AxiIn_r_payload_data[31:0]           ), //i
    .AxiOut_2_r_payload_resp  (clint_AxiIn_r_payload_resp[1:0]            ), //i
    .AxiOut_3_aw_valid        (axiarbiter_1_AxiOut_3_aw_valid             ), //o
    .AxiOut_3_aw_ready        (uart2_AxiIn_aw_ready                       ), //i
    ...
    .AxiOut_3_w_ready         (uart2_AxiIn_w_ready                        ), //i
    ...
    .AxiOut_3_b_valid         (uart2_AxiIn_b_valid                        ), //i
    .AxiOut_3_b_ready         (axiarbiter_1_AxiOut_3_b_ready              ), //o
    .AxiOut_3_b_payload_resp  (uart2_AxiIn_b_payload_resp[1:0]            ), //i
    .AxiOut_3_ar_valid        (axiarbiter_1_AxiOut_3_ar_valid             ), //o
    .AxiOut_3_ar_ready        (uart2_AxiIn_ar_ready                       ), //i
    ...
    .AxiOut_3_r_valid         (uart2_AxiIn_r_valid                        ), //i
    .AxiOut_3_r_ready         (axiarbiter_1_AxiOut_3_r_ready              ), //o
    .AxiOut_3_r_payload_data  (uart2_AxiIn_r_payload_data[31:0]           ), //i
    .AxiOut_3_r_payload_resp  (uart2_AxiIn_r_payload_resp[1:0]            ), //i
    .r_sel                    (ctrl_r_sel                                 ), //i
    .clock                    (clock                                      ), //i
    .reset                    (reset                                      )  //i
  );
  AXIUart uart (
    .AxiIn_aw_valid        (axiarbiter_1_AxiOut_1_aw_valid             ), //i
    .AxiIn_aw_ready        (uart_AxiIn_aw_ready                        ), //o
    .AxiIn_aw_payload_addr (axiarbiter_1_AxiOut_1_aw_payload_addr[31:0]), //i
    .AxiIn_aw_payload_prot (axiarbiter_1_AxiOut_1_aw_payload_prot[2:0] ), //i
    .AxiIn_w_valid         (axiarbiter_1_AxiOut_1_w_valid              ), //i
    .AxiIn_w_ready         (uart_AxiIn_w_ready                         ), //o
    .AxiIn_w_payload_data  (axiarbiter_1_AxiOut_1_w_payload_data[31:0] ), //i
    .AxiIn_w_payload_strb  (axiarbiter_1_AxiOut_1_w_payload_strb[3:0]  ), //i
    .AxiIn_b_valid         (uart_AxiIn_b_valid                         ), //o
    .AxiIn_b_ready         (axiarbiter_1_AxiOut_1_b_ready              ), //i
    .AxiIn_b_payload_resp  (uart_AxiIn_b_payload_resp[1:0]             ), //o
    .AxiIn_ar_valid        (axiarbiter_1_AxiOut_1_ar_valid             ), //i
    .AxiIn_ar_ready        (uart_AxiIn_ar_ready                        ), //o
    .AxiIn_ar_payload_addr (axiarbiter_1_AxiOut_1_ar_payload_addr[31:0]), //i
    .AxiIn_ar_payload_prot (axiarbiter_1_AxiOut_1_ar_payload_prot[2:0] ), //i
    .AxiIn_r_valid         (uart_AxiIn_r_valid                         ), //o
    .AxiIn_r_ready         (axiarbiter_1_AxiOut_1_r_ready              ), //i
    .AxiIn_r_payload_data  (uart_AxiIn_r_payload_data[31:0]            ), //o
    .AxiIn_r_payload_resp  (uart_AxiIn_r_payload_resp[1:0]             ), //o
    .clock                 (clock                                      ), //i
    .reset                 (reset                                      )  //i
  );
  AXIClint clint (
    .AxiIn_aw_valid        (axiarbiter_1_AxiOut_2_aw_valid             ), //i
    .AxiIn_aw_ready        (clint_AxiIn_aw_ready                       ), //o
    .AxiIn_aw_payload_addr (axiarbiter_1_AxiOut_2_aw_payload_addr[31:0]), //i
    .AxiIn_aw_payload_prot (axiarbiter_1_AxiOut_2_aw_payload_prot[2:0] ), //i
    .AxiIn_w_valid         (axiarbiter_1_AxiOut_2_w_valid              ), //i
    .AxiIn_w_ready         (clint_AxiIn_w_ready                        ), //o
    .AxiIn_w_payload_data  (axiarbiter_1_AxiOut_2_w_payload_data[31:0] ), //i
    .AxiIn_w_payload_strb  (axiarbiter_1_AxiOut_2_w_payload_strb[3:0]  ), //i
    .AxiIn_b_valid         (clint_AxiIn_b_valid                        ), //o
    .AxiIn_b_ready         (axiarbiter_1_AxiOut_2_b_ready              ), //i
    .AxiIn_b_payload_resp  (clint_AxiIn_b_payload_resp[1:0]            ), //o
    .AxiIn_ar_valid        (axiarbiter_1_AxiOut_2_ar_valid             ), //i
    .AxiIn_ar_ready        (clint_AxiIn_ar_ready                       ), //o
    .AxiIn_ar_payload_addr (axiarbiter_1_AxiOut_2_ar_payload_addr[31:0]), //i
    .AxiIn_ar_payload_prot (axiarbiter_1_AxiOut_2_ar_payload_prot[2:0] ), //i
    .AxiIn_r_valid         (clint_AxiIn_r_valid                        ), //o
    .AxiIn_r_ready         (axiarbiter_1_AxiOut_2_r_ready              ), //i
    .AxiIn_r_payload_data  (clint_AxiIn_r_payload_data[31:0]           ), //o
    .AxiIn_r_payload_resp  (clint_AxiIn_r_payload_resp[1:0]            ), //o
    .clock                 (clock                                      ), //i
    .reset                 (reset                                      )  //i
  );
  AXIUart uart2 (
    .AxiIn_aw_valid        (axiarbiter_1_AxiOut_3_aw_valid             ), //i
    .AxiIn_aw_ready        (uart2_AxiIn_aw_ready                       ), //o
    .AxiIn_aw_payload_addr (axiarbiter_1_AxiOut_3_aw_payload_addr[31:0]), //i
    .AxiIn_aw_payload_prot (axiarbiter_1_AxiOut_3_aw_payload_prot[2:0] ), //i
    .AxiIn_w_valid         (axiarbiter_1_AxiOut_3_w_valid              ), //i
    .AxiIn_w_ready         (uart2_AxiIn_w_ready                        ), //o
    .AxiIn_w_payload_data  (axiarbiter_1_AxiOut_3_w_payload_data[31:0] ), //i
    .AxiIn_w_payload_strb  (axiarbiter_1_AxiOut_3_w_payload_strb[3:0]  ), //i
    .AxiIn_b_valid         (uart2_AxiIn_b_valid                        ), //o
    .AxiIn_b_ready         (axiarbiter_1_AxiOut_3_b_ready              ), //i
    .AxiIn_b_payload_resp  (uart2_AxiIn_b_payload_resp[1:0]            ), //o
    .AxiIn_ar_valid        (axiarbiter_1_AxiOut_3_ar_valid             ), //i
    .AxiIn_ar_ready        (uart2_AxiIn_ar_ready                       ), //o
    .AxiIn_ar_payload_addr (axiarbiter_1_AxiOut_3_ar_payload_addr[31:0]), //i
    .AxiIn_ar_payload_prot (axiarbiter_1_AxiOut_3_ar_payload_prot[2:0] ), //i
    .AxiIn_r_valid         (uart2_AxiIn_r_valid                        ), //o
    .AxiIn_r_ready         (axiarbiter_1_AxiOut_3_r_ready              ), //i
