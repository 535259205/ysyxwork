...
module ysyxSoCFull (
  ...
  wire                soc_axi_clint_aw_valid;
  wire       [31:0]   soc_axi_clint_aw_payload_addr;
  wire       [2:0]    soc_axi_clint_aw_payload_prot;
  wire                soc_axi_clint_w_valid;
  wire       [31:0]   soc_axi_clint_w_payload_data;
  wire       [3:0]    soc_axi_clint_w_payload_strb;
  wire                soc_axi_clint_b_ready;
  wire                soc_axi_clint_ar_valid;
  wire       [31:0]   soc_axi_clint_ar_payload_addr;
  wire       [2:0]    soc_axi_clint_ar_payload_prot;
  wire                soc_axi_clint_r_ready;
  ...
  wire                axint_AxiIn_aw_ready;
  wire                axint_AxiIn_w_ready;
  wire                axint_AxiIn_b_valid;
  wire       [1:0]    axint_AxiIn_b_payload_resp;
  wire                axint_AxiIn_ar_ready;
  wire                axint_AxiIn_r_valid;
  wire       [31:0]   axint_AxiIn_r_payload_data;
  wire       [1:0]    axint_AxiIn_r_payload_resp;
  ...
  CPU soc (
    ...
    .axi_clint_aw_valid        (soc_axi_clint_aw_valid                ), //o
    .axi_clint_aw_ready        (axint_AxiIn_aw_ready                  ), //i
    .axi_clint_aw_payload_addr (soc_axi_clint_aw_payload_addr[31:0]   ), //o
    .axi_clint_aw_payload_prot (soc_axi_clint_aw_payload_prot[2:0]    ), //o
    .axi_clint_w_valid         (soc_axi_clint_w_valid                 ), //o
    .axi_clint_w_ready         (axint_AxiIn_w_ready                   ), //i
    .axi_clint_w_payload_data  (soc_axi_clint_w_payload_data[31:0]    ), //o
    .axi_clint_w_payload_strb  (soc_axi_clint_w_payload_strb[3:0]     ), //o
    .axi_clint_b_valid         (axint_AxiIn_b_valid                   ), //i
    .axi_clint_b_ready         (soc_axi_clint_b_ready                 ), //o
    .axi_clint_b_payload_resp  (axint_AxiIn_b_payload_resp[1:0]       ), //i
    .axi_clint_ar_valid        (soc_axi_clint_ar_valid                ), //o
    .axi_clint_ar_ready        (axint_AxiIn_ar_ready                  ), //i
    .axi_clint_ar_payload_addr (soc_axi_clint_ar_payload_addr[31:0]   ), //o
    .axi_clint_ar_payload_prot (soc_axi_clint_ar_payload_prot[2:0]    ), //o
    .axi_clint_r_valid         (axint_AxiIn_r_valid                   ), //i
    .axi_clint_r_ready         (soc_axi_clint_r_ready                 ), //o
    .axi_clint_r_payload_data  (axint_AxiIn_r_payload_data[31:0]      ), //i
    .axi_clint_r_payload_resp  (axint_AxiIn_r_payload_resp[1:0]       ), //i
  ...
  AXIClint axint (
    .AxiIn_aw_valid        (soc_axi_clint_aw_valid             ), //i
    .AxiIn_aw_ready        (axint_AxiIn_aw_ready               ), //o
    .AxiIn_aw_payload_addr (soc_axi_clint_aw_payload_addr[31:0]), //i
    .AxiIn_aw_payload_prot (soc_axi_clint_aw_payload_prot[2:0] ), //i
    .AxiIn_w_valid         (soc_axi_clint_w_valid              ), //i
    .AxiIn_w_ready         (axint_AxiIn_w_ready                ), //o
    .AxiIn_w_payload_data  (soc_axi_clint_w_payload_data[31:0] ), //i
    .AxiIn_w_payload_strb  (soc_axi_clint_w_payload_strb[3:0]  ), //i
    .AxiIn_b_valid         (axint_AxiIn_b_valid                ), //o
    .AxiIn_b_ready         (soc_axi_clint_b_ready              ), //i
    .AxiIn_b_payload_resp  (axint_AxiIn_b_payload_resp[1:0]    ), //o
    .AxiIn_ar_valid        (soc_axi_clint_ar_valid             ), //i
    .AxiIn_ar_ready        (axint_AxiIn_ar_ready               ), //o
    .AxiIn_ar_payload_addr (soc_axi_clint_ar_payload_addr[31:0]), //i
    .AxiIn_ar_payload_prot (soc_axi_clint_ar_payload_prot[2:0] ), //i
    .AxiIn_r_valid         (axint_AxiIn_r_valid                ), //o
    .AxiIn_r_ready         (soc_axi_clint_r_ready              ), //i
    .AxiIn_r_payload_data  (axint_AxiIn_r_payload_data[31:0]   ), //o
    .AxiIn_r_payload_resp  (axint_AxiIn_r_payload_resp[1:0]    ), //o
    .clock                 (clock                              ), //i
    .reset                 (reset                              )  //i
  );
