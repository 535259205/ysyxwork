...
module GRP (
  ...
  reg        [31:0]   reg_31;
  wire                rd_vaild;
  wire                when_MyCpu_l179;
  wire       [31:0]   _zz_1;
  wire                when_MyCpu_l183;
  wire                when_MyCpu_l188;
  ...
  assign when_MyCpu_l179 = (com_encode_rd_sel != 5'h0);
  assign _zz_1 = ({31'd0,1'b1} <<< com_encode_rd_sel);
  assign when_MyCpu_l183 = (com_encode_rs1_sel != 5'h0);
  always @(*) begin
    if(when_MyCpu_l183) begin
  ...
  assign when_MyCpu_l188 = (com_encode_rs2_sel != 5'h0);
  always @(*) begin
    if(when_MyCpu_l188) begin
