...
void Vtop___024root____Vdpiimwrap_top__DOT__pc_1__DOT__rom__DOT__rom_r_TOP(IData/*31:0*/ addr, IData/*31:0*/ &rom_r__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop___024root____Vdpiimwrap_top__DOT__pc_1__DOT__rom__DOT__rom_r_TOP\n"); );
    // Body
    int addr__Vcvt;
    addr__Vcvt = addr;
...
void Vtop___024root____Vdpiimwrap_top__DOT__exmem_1__DOT__mem__DOT__mem_w_TOP(IData/*31:0*/ data, IData/*31:0*/ addr, IData/*31:0*/ len) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop___024root____Vdpiimwrap_top__DOT__exmem_1__DOT__mem__DOT__mem_w_TOP\n"); );
    // Body
    int data__Vcvt;
    data__Vcvt = data;
    int addr__Vcvt;
...
void Vtop___024root____Vdpiimwrap_top__DOT__exmem_1__DOT__mem__DOT__mem_r_TOP(IData/*31:0*/ addr, IData/*31:0*/ len, IData/*31:0*/ &mem_r__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtop___024root____Vdpiimwrap_top__DOT__exmem_1__DOT__mem__DOT__mem_r_TOP\n"); );
    // Body
    int addr__Vcvt;
    addr__Vcvt = addr;
    int len__Vcvt;
...
void Vtop___024root___eval_triggers__act(Vtop___024root* vlSelf) {
    ...
    vlSelfRef.__VactTriggered[0U] = (QData)((IData)(
                                                    (((((((IData)(vlSelfRef.top__DOT__encode_1_com_exmem_w_len) 
                                                          != (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__DOT__encode_1_com_exmem_w_len__0)) 
                                                         << 3U) 
                                                       ...
                                                       | (((vlSelfRef.top__DOT__encode_1_com_exmem_w_addr 
                                                           ...
                                                           << 1U) 
                                                          | ((IData)(vlSelfRef.top__DOT__encode_1_com_exmem_r_len) 
                                                             != (IData)(vlSelfRef.__Vtrigprevexpr___TOP__top__DOT__encode_1_com_exmem_r_len__0)))) 
                                                      << 4U) 
...
void Vtop___024root___nba_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    if (vlSelfRef.top__DOT__encode_1_com_exmem_w_vaild) {
        Vtop___024root____Vdpiimwrap_top__DOT__exmem_1__DOT__mem__DOT__mem_w_TOP(vlSelfRef.top__DOT__encode_1_com_exmem_w_data, vlSelfRef.top__DOT__encode_1_com_exmem_w_addr, 
                                                                                ((IData)(1U) 
                                                                                + (IData)(vlSelfRef.top__DOT__encode_1_com_exmem_w_len)));
    }
}
...
void Vtop___024root___nba_sequent__TOP__1(Vtop___024root* vlSelf) {
    ...
    Vtop___024root____Vdpiimwrap_top__DOT__pc_1__DOT__debug__DOT__debug_fun_1__DOT__debug_TOP(0x00000028U, (IData)(
                                                                                ...
                                                                                >> 0x00000020U)));
    Vtop___024root____Vdpiimwrap_top__DOT__pc_1__DOT__debug__DOT__debug_fun_1__DOT__debug_TOP(0x00000022U, vlSelfRef.top__DOT__pc_1__DOT__rom_code);
    ...
    if (vlSelfRef.rst) {
        ...
        if (vlSelfRef.top__DOT__encode_1_com_csr_ecall) {
            ...
            if (vlSelfRef.top__DOT__encode_1_com_csr_vaild) {
                if ((0x0300U != (vlSelfRef.top__DOT__pc_1__DOT__rom_code 
                                 >> 0x00000014U))) {
                    if ((0x0305U != (vlSelfRef.top__DOT__pc_1__DOT__rom_code 
                                     >> 0x00000014U))) {
                        if ((0x0342U == (vlSelfRef.top__DOT__pc_1__DOT__rom_code 
                                         >> 0x00000014U))) {
                        ...
                        if ((0x0342U != (vlSelfRef.top__DOT__pc_1__DOT__rom_code 
                                         >> 0x00000014U))) {
                            if ((0x0341U == (vlSelfRef.top__DOT__pc_1__DOT__rom_code 
                                             >> 0x00000014U))) {
        ...
        if (vlSelfRef.top__DOT__encode_1_com_grp_rd_vaild) {
            if ((0U != (0x0000001fU & (vlSelfRef.top__DOT__pc_1__DOT__rom_code 
                                       >> 7U)))) {
...
void Vtop___024root___nba_sequent__TOP__3(Vtop___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    IData/*31:0*/ __Vfunc_top__DOT__exmem_1__DOT__mem__DOT__mem_r__43__Vfuncout;
    __Vfunc_top__DOT__exmem_1__DOT__mem__DOT__mem_r__43__Vfuncout = 0;
    // Body
    if (vlSelfRef.top__DOT__encode_1_com_exmem_r_ready) {
        Vtop___024root____Vdpiimwrap_top__DOT__exmem_1__DOT__mem__DOT__mem_r_TOP(vlSelfRef.top__DOT__encode_1_com_exmem_r_addr, 
                                                                                ((IData)(1U) 
                                                                                + (IData)(vlSelfRef.top__DOT__encode_1_com_exmem_r_len)), __Vfunc_top__DOT__exmem_1__DOT__mem__DOT__mem_r__43__Vfuncout);
        vlSelfRef.top__DOT__exmem_1__DOT__mem_r_data 
            = __Vfunc_top__DOT__exmem_1__DOT__mem__DOT__mem_r__43__Vfuncout;
    }
}
...
void Vtop___024root___nba_sequent__TOP__4(Vtop___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Locals
    IData/*31:0*/ __Vfunc_top__DOT__pc_1__DOT__rom__DOT__rom_r__0__Vfuncout;
    __Vfunc_top__DOT__pc_1__DOT__rom__DOT__rom_r__0__Vfuncout = 0;
    // Body
    Vtop___024root____Vdpiimwrap_top__DOT__pc_1__DOT__rom__DOT__rom_r_TOP(vlSelfRef.top__DOT__pc_1__DOT__PC_cnt, __Vfunc_top__DOT__pc_1__DOT__rom__DOT__rom_r__0__Vfuncout);
    vlSelfRef.top__DOT__pc_1__DOT__rom_code = __Vfunc_top__DOT__pc_1__DOT__rom__DOT__rom_r__0__Vfuncout;
