...
void VTOPmod_std__03a__03asemaphore__Vclpkg___ctor_var_reset(VTOPmod_std__03a__03asemaphore__Vclpkg* vlSelf);

void VTOPmod_std__03a__03asemaphore__Vclpkg::ctor(VTOPmod__Syms* symsp, const char* namep) {
    vlSymsp = symsp;
    vlNamep = strdup(Verilated::catName(vlSymsp->name(), namep));
    // Reset structure values
    VTOPmod_std__03a__03asemaphore__Vclpkg___ctor_var_reset(this);
}
