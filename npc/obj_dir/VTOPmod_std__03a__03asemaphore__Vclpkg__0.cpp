...
VTOPmod_std__03a__03asemaphore::VTOPmod_std__03a__03asemaphore(VTOPmod__Syms* __restrict vlSymsp, IData/*31:0*/ keyCount) {
...
std::string VL_TO_STRING(const VlClassRef<VTOPmod_std__03a__03asemaphore>& obj) {
    VL_DEBUG_IF(VL_DBG_MSGF("+            VTOPmod_std__03a__03asemaphore::VL_TO_STRING\n"); );
    // Body
