...
module AXIXbar (
  ...
  output wire          axi_s_aw_valid,
  input  wire          axi_s_aw_ready,
  output wire [31:0]   axi_s_aw_payload_addr,
  output wire [3:0]    axi_s_aw_payload_id,
  output wire [7:0]    axi_s_aw_payload_len,
  output wire [2:0]    axi_s_aw_payload_size,
  output wire [1:0]    axi_s_aw_payload_burst,
  output wire          axi_s_w_valid,
  input  wire          axi_s_w_ready,
  output wire [31:0]   axi_s_w_payload_data,
  output wire [3:0]    axi_s_w_payload_strb,
  output wire          axi_s_w_payload_last,
  input  wire          axi_s_b_valid,
  output wire          axi_s_b_ready,
  ...
  assign axi_s_w_valid = axi_m_1_w_valid;
  assign axi_m_1_w_ready = axi_s_w_ready;
  assign axi_s_w_payload_data = axi_m_1_w_payload_data;
  assign axi_s_w_payload_strb = axi_m_1_w_payload_strb;
  assign axi_s_w_payload_last = axi_m_1_w_payload_last;
  assign axi_s_aw_valid = axi_m_1_aw_valid;
  assign axi_m_1_aw_ready = axi_s_aw_ready;
  assign axi_s_aw_payload_addr = axi_m_1_aw_payload_addr;
  assign axi_s_aw_payload_id = axi_m_1_aw_payload_id;
  assign axi_s_aw_payload_len = axi_m_1_aw_payload_len;
  assign axi_s_aw_payload_size = axi_m_1_aw_payload_size;
  assign axi_s_aw_payload_burst = axi_m_1_aw_payload_burst;
  assign axi_m_1_b_valid = axi_s_b_valid;
  assign axi_s_b_ready = axi_m_1_b_ready;
  assign axi_m_1_b_payload_id = axi_s_b_payload_id;
  assign axi_m_1_b_payload_resp = axi_s_b_payload_resp;
