...
module AXIArbiter (
  ...
  always @(*) begin
    if(((32'h80000000 <= AxiIn_1_aw_payload_addr) && (AxiIn_1_aw_payload_addr < 32'h80ffffff))) begin
      wsel = 2'b00;
    end else begin
      if(((32'h10000000 <= AxiIn_1_aw_payload_addr) && (AxiIn_1_aw_payload_addr < 32'h1000ffff))) begin
        wsel = 2'b01;
      end else begin
        if(((32'h11000000 <= AxiIn_1_aw_payload_addr) && (AxiIn_1_aw_payload_addr < 32'h1100ffff))) begin
          wsel = 2'b10;
        end else begin
          wsel = 2'b11;
        end
